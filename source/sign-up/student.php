    ...
    <div class="container">
        <div class="signup-form">
            <form method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                <h5>As a Student</h5>
                <button id="myBtn" class="btn btn-primary btn-lg" style="margin-bottom: 1em;">Register as a Course Creator</button>
                  <script>
                    var btn = document.getElementById('myBtn');
                    btn.addEventListener('click', function() {
                      document.location.href = '<?php echo "course-creator.php"; ?>';
                    });
                  </script>
